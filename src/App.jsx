...
const CONTACT = {
  ...
  scheduleUrl: "https://calendar.app.google/JBBpb6xQo5hSq1rz9",
};
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      ...
      <style>{`
        ...
        .btn-load {
          background: #1a3a2a; color: #d4af6a;
    ...
    <div className="proposal-wrapper">
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-tool { background: #fff; color: #1a3a2a; border: 1.5px solid #1a3a2a; }
        .btn-tool:hover { background: #f0f5f2; }
        .btn-print { background: #1a3a2a; color: #d4af6a; letter-spacing: 0.03em; }
        .btn-print:hover { background: #0f2318; }
        .proposal { max-width: 860px; margin: 0 auto; background: #fff; box-shadow: 0 8px 48px rgba(0,0,0,0.12); }
        .proposal-header { background: #1a3a2a; padding: 28px 40px; display: flex; justify-content: space-between; align-items: center; }
        .header-logo-area { display: flex; align-items: center; gap: 14px; }
        .logo-mark { width: 44px; height: 44px; background: #d4af6a; color: #1a3a2a; border-radius: 50%; font-family: 'Playfair Display', serif; font-size: 22px; font-weight: 900; display: flex; align-items: center; justify-content: center; }
        ...
        .cover-section { background: linear-gradient(135deg, #1a3a2a 0%, #0f2318 100%); padding: 60px 40px 50px; position: relative; overflow: hidden; }
        ...
        .section-divider span { font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; font-weight: 700; color: #1a3a2a; }
        ...
        .stat-num { font-family: 'Playfair Display', serif; font-size: 26px; font-weight: 900; color: #1a3a2a; }
        ...
        .roi-card.highlight-card { background: #1a3a2a; border-color: #1a3a2a; }
        ...
        .roi-value { font-family: 'Playfair Display', serif; font-size: 28px; font-weight: 900; color: #1a3a2a; }
        ...
        .package-highlighted { border-color: #1a3a2a; background: #f7f9f8; box-shadow: 0 4px 20px rgba(26,58,42,0.1); }
        .popular-badge { position: absolute; top: -12px; left: 50%; transform: translateX(-50%); background: #1a3a2a; color: #d4af6a; font-size: 9px; font-weight: 700; letter-spacing: 0.15em; padding: 4px 14px; border-radius: 20px; white-space: nowrap; }
        .pkg-name { font-size: 11px; font-weight: 700; letter-spacing: 0.15em; text-transform: uppercase; color: #1a3a2a; margin-bottom: 10px; }
        .pkg-setup { font-size: 12px; color: #888; margin-bottom: 6px; }
        .setup-label { font-weight: 600; color: #555; margin-right: 4px; }
        .setup-val { color: #1a3a2a; font-weight: 600; }
        ...
        .pkg-free-badge { display: inline-block; background: #e8f5ee; color: #1a3a2a; font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 20px; margin-bottom: 12px; }
        ...
        .check { color: #1a3a2a; font-weight: 700; flex-shrink: 0; }
        .proposal-footer { background: #1a3a2a; padding: 40px 40px 36px; display: flex; justify-content: space-between; align-items: flex-start; gap: 24px; flex-wrap: wrap; }
        ...
        .footer-schedule-btn { display: inline-block; background: #d4af6a; color: #1a3a2a; font-size: 13px; font-weight: 700; padding: 10px 22px; border-radius: 6px; text-decoration: none; letter-spacing: 0.02em; }
    ...
    <div className="form-wrapper">
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-header { background: #1a3a2a; padding: 24px 32px; display: flex; justify-content: space-between; align-items: center; }
        .form-logo { display: flex; align-items: center; gap: 14px; }
        .form-logo-mark { width: 42px; height: 42px; background: #d4af6a; color: #1a3a2a; border-radius: 50%; font-family: 'Playfair Display', serif; font-size: 20px; font-weight: 900; display: flex; align-items: center; justify-content: center; }
        ...
        .field input:focus, .field select:focus { border-color: #1a3a2a; }
        ...
        .generate-btn.ready { background: #1a3a2a; color: #d4af6a; }
        .generate-btn.ready:hover { background: #0f2318; transform: translateY(-1px); box-shadow: 0 4px 14px rgba(26,58,42,0.25); }
